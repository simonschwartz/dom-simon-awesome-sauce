...
#[derive(Debug)]
struct WobbleState {
    line1: ((char,LetterState), (char,LetterState), (char,LetterState), (char,LetterState), (char,LetterState)),
    line2: ((char,LetterState), (char,LetterState), (char,LetterState), (char,LetterState), (char,LetterState)),
    line3: ((char,LetterState), (char,LetterState), (char,LetterState), (char,LetterState), (char,LetterState)),
    line4: ((char,LetterState), (char,LetterState), (char,LetterState), (char,LetterState), (char,LetterState)),
    line5: ((char,LetterState), (char,LetterState), (char,LetterState), (char,LetterState), (char,LetterState)),
    line6: ((char,LetterState), (char,LetterState), (char,LetterState), (char,LetterState), (char,LetterState)),
}
...
fn build_layout() -> impl Widget<CalcState> {
	...
	Flex::column()
			...
			.with_flex_child(
					flex_row(
							op_button_label('q', "BLOE".to_string()),
							op_button('C'),
							op_button('⌫'),
							op_button('÷'),
					),
